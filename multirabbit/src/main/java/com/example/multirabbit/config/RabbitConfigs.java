...
import com.example.multirabbit.service.ConsumerService;
...
public class RabbitConfigs {
    ...
    @Bean("dmm_vhost_ConnectionFactory")
    public ConnectionFactory dmm_vhost_ConnectionFactory() {

        CachingConnectionFactory connectionFactory = new CachingConnectionFactory();
        connectionFactory.setHost("localhost");
        connectionFactory.setVirtualHost("dmm_vhost");
        connectionFactory.setUsername("dmmRabbitUser");
        connectionFactory.setPassword("021120");
        return connectionFactory;
    }

    @Bean("pga_vhost_ConnectionFactory")
    public ConnectionFactory pga_vhost_ConnectionFactory() {
